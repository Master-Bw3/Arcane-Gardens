...
abstract class ArcaneGardensModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<ArcaneGardensModDependenciesExtension>("arcaneGardensModDependencies")
